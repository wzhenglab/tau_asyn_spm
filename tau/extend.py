...
f = gsd.hoomd.open(name='resize4.gsd', mode='rb')
s=f[0]
...
integrator = hoomd.md.integrate.langevin(group=all, kT=kTinput, seed=62566)
#gamma=0.01
gamma=0.01
for i in aakeys:
...
## Outputs
hoomd.analyze.log('extend.log', quantities=['bond_harmonic_energy','pair_ashbaugh_energy','pair_yukawa_energy','potential_energy','kinetic_energy','temperature','lx','ly','lz'], period=10000, overwrite=True, header_prefix='#')
